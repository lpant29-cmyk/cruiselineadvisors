...
**The content strategy — pillar/cluster topic map, semantic-SEO rules, interlinking, visual standards,
the repeatable "how to add a rich guide" system, and publishing cadence — is in `docs/CONTENT-PLAN.md`.**
