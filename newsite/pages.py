...
GUIDES = [
    ...
    {"slug": "cruise-travel-insurance", "emo": "🛟",
     "t": {"en": "Cruise travel insurance: is it worth it?", "es": "Seguro de viaje para crucero: ¿vale la pena?"},
     "d": {"en": "What it covers, why cruises are a special case, and how to decide.",
           "es": "Qué cubre, por qué un crucero es especial y cómo decidir."}},
    {"slug": "onboard-credit-explained", "emo": "💳",
     "t": {"en": "Onboard credit, explained", "es": "Crédito a bordo, explicado"},
     "d": {"en": "Where it comes from, refundable vs not, and how to spend it well.",
           "es": "De dónde viene, reembolsable o no, y cómo gastarlo bien."}},
    {"slug": "cruise-glossary", "emo": "📖",
     "t": {"en": "A to Z cruise glossary", "es": "Glosario de cruceros de la A a la Z"},
     "d": {"en": "Every cruise word explained in plain English, grouped by when you meet it.",
           "es": "Cada término explicado en lenguaje claro, agrupado por cuándo aparece."}},
    {"slug": "couples-adults-only-cruising", "emo": "💑",
     "t": {"en": "Cruising for couples & adults-only", "es": "Cruceros en pareja y solo adultos"},
     "d": {"en": "Adults-only decks, quieter ships, and when to sail for calm.",
           "es": "Cubiertas solo para adultos, barcos tranquilos y cuándo navegar."}},
    {"slug": "contemporary-premium-luxury", "emo": "🎚️",
     "t": {"en": "Contemporary vs premium vs luxury lines", "es": "Contemporánea vs premium vs lujo"},
     "d": {"en": "What the three tiers really describe, and which one fits your trip.",
           "es": "Qué describen los tres niveles y cuál encaja con tu viaje."}},
    {"slug": "best-cabin-location", "emo": "🧭",
     "t": {"en": "Best cabin location: deck, midship & what to avoid", "es": "Mejor ubicación del camarote: cubierta, centro y qué evitar"},
     "d": {"en": "How deck height, fore/aft and what's above you shape your cruise.",
           "es": "Cómo la cubierta, la proa/popa y lo que hay arriba moldean tu crucero."}},
    {"slug": "bahamas-romance-travel", "emo": "💍",
     "t": {"en": "Romance in the Bahamas", "es": "Romance en las Bahamas"},
     "d": {"en": "Honeymoons, weddings, and where to say I do across the islands.",
           "es": "Lunas de miel, bodas y dónde decir sí en las islas."}},
...
GUIDE_META = {
    ...
    "cruise-travel-insurance": {"cat": "costs", "ctx": ["home"]},
    "onboard-credit-explained": {"cat": "costs", "ctx": ["home", "line"]},
    "best-cabin-location": {"cat": "planning", "ctx": ["ship", "home"]},
    "bahamas-romance-travel": {"cat": "dest", "ctx": ["home", "dest"]},
    "what-to-pack-for-a-cruise": {"cat": "planning", "ctx": ["ship"]},
    "cruise-embarkation-day": {"cat": "planning", "ctx": ["ship"]},
    "cruise-glossary": {"cat": "planning", "ctx": ["home"]},
    "couples-adults-only-cruising": {"cat": "who", "ctx": ["home", "ship"]},
    "contemporary-premium-luxury": {"cat": "line", "ctx": ["line", "home"]},
