...
KIDS_PROGRAMS = {
    ...
    "holland-america": {
        "source": "https://www.hollandamerica.com/en/us/onboard-experiences/activities/kids-club",
        "verified": "2026-09-23",
        "cards": [
            {"name": "Kids Club", "ages": "3-6", "emo": "⚓",
             "desc": {"en": "Supervised arts and crafts, sports and games.",
                      "es": "Manualidades, deportes y juegos supervisados."}},
            {"name": "Tweens", "ages": "7-11", "emo": "🎨",
             "desc": {"en": "Arts and crafts, sports, gaming tournaments and movie nights.",
                      "es": "Manualidades, deportes, torneos de videojuegos y cine."}},
            {"name": "Teens", "ages": "12-17", "emo": "🎮",
             "desc": {"en": "Sports, group games, movie nights and a dedicated hangout.",
                      "es": "Deportes, juegos en grupo, cine y un espacio propio."}},
        ],
    },
    "celebrity": {
